...
def generate_atari_db(platform_dir=None):
    ...
    print(f"Generating Atari 2600 database at {db_path}...")
    ...
    conn.close()
    print(f"Successfully compiled {total_count} Atari 2600 games into {db_path}!\n")
